    ...
    <main>
      <div className="intro">
        <div className="intro__background">
          <picture>
            <source type="image/webp" srcSet="assets/img/content/sitemap/background.webp 1x, assets/img/content/sitemap/background@2x.webp 2x" />
            <img
        ...
        <div className="intro__wrapper">
          ...
          <div className="intro__title-logo">
            <picture>
              <source type="image/webp" srcSet="assets/img/content/sitemap/title-logo.webp 1x, assets/img/content/sitemap/title-logo@2x.webp 2x" />
              <img
